                ...
                <div key={req.id} className="rounded-xl border border-border bg-card p-4 shadow-soft">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Seller: {req.sellerId} · Qty: {req.quantity} · Payment: {req.paymentMode}</p>
                  ...
                  <div className="mt-3 flex items-center gap-2 rounded-lg bg-primary/10 p-3">
                    ...
                    <span className="text-sm font-semibold text-primary">Order placed successfully! Payment mode: {req.paymentMode}</span>
                  </div>
                </div>
              );
            })
